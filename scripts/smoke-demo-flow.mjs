...
assert(
  mindHive.hive?.overview?.syntheticResponseCount === 10,
  "expected ten approved synthetic participant responses"
);
assert(
...
console.log("OK   ten approved synthetic participant responses labelled separately");
